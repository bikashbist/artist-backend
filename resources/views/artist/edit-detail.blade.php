...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="header__logo">
                                <a href="/"> <img src=" {{ asset('artist-frontend/logo-artist.png') }} " alt="logo"></a>
    ...
    <div class="container">
        <div class="col-md-4">
            ...
            @endif
            <form action=" {{url('update-detail', [Auth::user()->id])}} " method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-12 ">
                        <div class="form-outline">
                            ...
                            <textarea name="detail" class="form-control" id="exampleFormControlTextarea1"
                                rows="3">{{{ Auth::user()->detail }}}</textarea>
                        </div>
                        @error('image')
